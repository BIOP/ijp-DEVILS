...
@Plugin(type = Command.class, menuPath = "Plugins>BIOP>Image Processing>DEVILS Preview ( Basic )")
public class DevilsInteractiveBasicCommand extends InteractiveCommand {
